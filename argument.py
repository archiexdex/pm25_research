...
def add_arguments(parser):
    ...
    parser.add_argument('--patience',     type=int,   default=0,    help='')
    ...
    parser.add_argument('--ratio',           type=float, default=2,    help='the ratio using in preprocess to set default threshold as ratio * sigma')
    ...
    parser.add_argument('--use_threshold',    action='store_true',      help='')
    parser.add_argument('--use_min_threshold',action='store_true',      help='')

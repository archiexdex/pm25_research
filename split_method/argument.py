...
def add_arguments(parser):
    ...
    parser.add_argument('--memory_size',     type=int,   default=80, help='The size of histry data 8760 for one year, 6570 for 9 months, 4380 for 6 months, 2160 for 3 months, 730 for 1 month')
    parser.add_argument('--window_size',     type=int,   default=50,    help='The size of history data period, it only use in fudan model.')
    parser.add_argument('--source_size',     type=int,   default=48,   help='The size of current data period.')
    parser.add_argument('--target_size',     type=int,   default=12,    help='')
